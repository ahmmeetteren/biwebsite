...
if (isset($_POST['guncelle'])) {
    ...
    $sabitTelefon = $_POST['sabitTelefon'];
    $adres = $_POST['adres'];

    $sorgu = mysqli_query($baglanti, "UPDATE yoneticiler SET yon_ad='" . $ad . "', yon_soyad='" . $soyad . "',sifre='" . $sifre . "', email='" . $email . "', cepTelefonu='" . $cepTelefonu . "', sabitTelefon='" . $sabitTelefon . "', adres='" . $adres . "' WHERE yon_id='" . $user_id . "'");
}
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-3 ms-md-5">
                    <div class="p-3 py-5">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6"><label style="font-size:15px;" class="form-label">Ad</label><input type="text" class="form-control" name="ad" value="<?= $row['yon_ad']; ?>"></div>
                            <div class="col-md-6"><label style="font-size:15px;" class="form-label">Soyad</label><input type="text" class="form-control" name="soyad" value="<?= $row['yon_soyad']; ?>"></div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-12"><label style="font-size:15px;" class="form-label">Telefon Numarası</label><input type="text" class="form-control" name="cepTelefonu" value="<?= $row['cepTelefonu']; ?>"></div>
                            <div class="col-md-12"><label style="font-size:15px;" class="form-label">Sabit Telefon</label><input type="text" class="form-control" name="sabitTelefon" value="<?= $row['sabitTelefon']; ?>"></div>
                            <div class="col-md-12"><label style="font-size:15px;" class="form-label">Adres</label><input type="text" class="form-control" name="adres" value="<?= $row['adres']; ?>"></div>
                            <div class="col-md-12"><label style="font-size:15px;" class="form-label">Email</label><input type="text" class="form-control" name="email" value="<?= $row['email']; ?>"></div>
                            <div class="col-md-12"><label style="font-size:15px;" class="form-label">Şifre</label><input type="password" class="form-control" name="sifre" value="<?= $row['sifre']; ?>"></div>
                        </div>
                        <div class="mt-5 text-center">
                            <input type="submit" value="Güncelle" name="guncelle" class="btn btn-primary w-100">
                        </div>
                    </div>
                </div>
            </div>
